...
- Real directory deletion is non-recursive and fails unless the directory is empty. Deleting a directory symlink removes the link without touching its target.
